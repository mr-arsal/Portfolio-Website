...
const Contact = (props) => {
    ...
    return (
        <>
            ...
            <div className='container d-flex  align-items-center query-textcenter-md screen-height' style={{ height: "650px" }}>
                <form ref={form} onSubmit={sendEmail} className='full-widht margin-top ' style={{ width: '40%' }}>
                    <div className="mb-3">
                        <label htmlFor="exampleFormControlInput1" className="form-label"><span className={`nem-lg fs-5 fw-bold  contact-npem text-${props.mode === 'light' ? 'black' : 'white'}`}>Name</span> </label>
                    ...
                    <div className="mb-3">
                        <label htmlFor="exampleFormControlInput1" className="form-label"><span className={`nem-lg fs-5 fw-bold contact-npem text-${props.mode === 'light' ? 'black' : 'white'}`}>Email</span></label>
                    ...
                    <div className="mb-3">
                        <label htmlFor="exampleFormControlTextarea1" className="form-label"><span className={`nem-lg fs-5 fw-bold  contact-npem text-${props.mode === 'light' ? 'black' : 'white'}`}>Massage</span></label>
                ...
                <div className={`contact_middle text-${props.mode === 'light' ? 'primary' : 'white'} full-widht container margin-top p-lg-4 json-middle lh-lg fs-5 json-text json-width-contact shadow rounded json-padding`} style={{ backgroundColor: props.mode === 'light' ? 'white' : 'rgb(35, 35, 35)' }}>
                    ...
                    <div>3 &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;"contact" : <span className='fw-bold'>03350505088</span> </div>
                    <div>4 &nbsp; &nbsp; &nbsp; &#125;</div>
                </div>
            </div>

...
import arsal from '../Image/arslan image.png'
import pdf from '../Resume/Arslan Nadeem-Full Stack Developer.pdf'

const aboutMe = (props) => {

    document.title = `${props.aboutMe} - Arslan Nadeem`
    return (
        <>
            ...
            <div className='container d-flex query-textcenter-md align-items-center margin-top screen-height' style={{ height: "650px" }}>
                <div className="query-textcenter " >
                    <img src={arsal} alt="Arslan Nadeem" className='arsal' />
                </div>
